...
public class Multiple_Remote_Test extends Hooks {
    ...
    void testMultipleRemote() {
        ...
        // 6. Verify that the suggestion menu is not displayed
        assertFalse(multipleRemotePage.isSuggestionListVisible(),
                "Suggestion list is visible with input 's'");
        ...
        // 9. Verify that "Loading suggestions..." message is displayed
        assertTrue(multipleRemotePage.isLoadingTextVisible(),
                "Loading text is not visible with input 'sp'");

        // 10. Verify that the suggestion menu is displayed
        assertTrue(multipleRemotePage.isSuggestionListVisible(),
                "Suggestion list is not visible with input 'sp'");

        // 11.Verify that the suggestions in the menu starts with sp(suggestions can be more than one)
        assertTrue(multipleRemotePage.checkSuggestionsStartsWith("sp"),
                "Suggestions don't start with correct letters");
    }
}
